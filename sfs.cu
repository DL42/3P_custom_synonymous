...
struct sim_result{
	...
	int * mutations_gen; //generation mutations appeared in simulation
	...
	sim_result(): num_populations(0), num_mutations(0), num_sites(0), total_generations(0) { mutations_freq = NULL; mutations_gen = NULL; }
