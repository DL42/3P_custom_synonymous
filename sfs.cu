...
__host__ __forceinline__ GO_Fish::sim_result sequencing_sample(GO_Fish::sim_result sim, int * population, int * num_samples, const int seed){
	//neutral neu;
	//no_mig mig;
...
__host__ __forceinline__ sfs site_frequency_spectrum(GO_Fish::sim_result sim, int * population, int * num_samples, int num_sfs_populations, const int seed){
	GO_Fish::sim_result samp = sequencing_sample(sim, population, num_samples, seed);

	return sfs();
}

//multi-time point, multi-population sfs
__host__ __forceinline__ sfs temporal_site_frequency_spectrum(GO_Fish::sim_result sim, int * population, int * num_samples, int num_sfs_populations, const int seed){
	GO_Fish::sim_result samp = sequencing_sample(sim, population, num_samples, seed);
