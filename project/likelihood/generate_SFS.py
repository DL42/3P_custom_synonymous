...
if __name__ == '__main__':
	...
	gamma = np.array([0,-4,-200],dtype=np.float64)
	dominance = np.array([0.5,0.5,0.5],dtype=np.float64) #effectively ignored since inbreeding is set to 1
	proportion = np.array([0.55,0.35,0.10],dtype=np.float64)
