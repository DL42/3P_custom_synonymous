...
int main(int argc, char **argv){
	...
	outfile<<b;													//prints allele_trajectory b to file
	outfile.close();
	...
	//prints the first 10 mutations from burn-in simulation
	...
	//prints the first 10 mutations from scenario simulation
